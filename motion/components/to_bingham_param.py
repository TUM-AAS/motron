...
class ToBMMParameter(Module):
    def __init__(self, input_size: int, output_state_size: int, G, T, **kwargs):
        super().__init__()
        self.to_loc = StaticGraphLinear(input_size, output_state_size - 1, num_nodes=21, node_types=node_types)
        self.to_log_Z = StaticGraphLinear(input_size, output_state_size - 1, num_nodes=21, node_types=node_types)
